...
#define STR0011  "NUMERO         P R O D U T O                                                  CENTRO    EMISSAO      ENTREGA     ENTREGA       QUANTIDADE          SALDO A      ST TP"
#define STR0012  "                                                                            DE CUSTO                PREVISTA        REAL         ORIGINAL         ENTREGAR"
#define STR0013  "CANCELADO PELO OPERADOR"
#define STR0014  "Total ---->"
#define STR0015  "NUMERO         P R O D U T O                                                  CENTRO    EMISSAO      ENTREGA     ENTREGA       QUANTIDADE          SALDO A      "
#define STR0016  "NUMERO         P R O D U T O                                 CENTRO  EMISSAO  ENTREGA  ENTREGA     QUANTIDADE        SALDO A ST TP"
#define STR0017  "                                                           DE CUSTO          PREVISTA     REAL       ORIGINAL       ENTREGAR"
#define STR0018  "NUMERO         P R O D U T O                                 CENTRO  EMISSAO  ENTREGA  ENTREGA     QUANTIDADE        SALDO A      "
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
*/
User Function DM_MATR850()
Local oReport

If FindFunction("TRepInUse") .And. TRepInUse()
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ7ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³Interface de impressao                                                  ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄnÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oReport:= ReportDef()
	oReport:PrintDialog()
Else
	MATR850R3()
...
#IFDEF TOP
	If !lAS400 ///SE NAO FOR AS/400
		...
		If !Empty(mv_par12)
			cWhere03 += "C2_OPMIDO = '"+mv_par12+"' AND " 		
		Endif
...
#ENDIF
	...
	If !Empty(mv_par12)  // O.P.s EM ABERTO
		cFiltro += ".And. C2_OPMIDO = '"+mv_par12+"' "
	Endif 
...
#IFDEF TOP 
	If !lAS400 ///SE NAO FOR AS/400
		...
		If !Empty(mv_par12)
			cQuery    += "SC2.C2_OPMIDO = '"+mv_par12+"' AND "			
		Endif	
...
#ENDIF 
	...
	If !Empty(mv_par12)
		cQuery    += ".And. SC2.C2_OPMIDO = '"+mv_par12+"' "			
	Endif	
...
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³Retorna celulas informadas pelo usuário que deveram         ³±±
